...
# Basic parameters
NDK_RELEASE=${NDK_RELEASE:-r21}
NDK_MD5=d2598b112f077f6d1f4d8d79363d6a96
NDK_API=${NDK_API:-14}
...
export CC="${NDK_TARGET}29-clang"
export CXX="${NDK_TARGET}29-clang++"
# TODO(iphydf): Make PIC work. Currently this breaks GHC compile.
#export CFLAGS="-fPIC"
#export CXXFLAGS="-fPIC"
export CFLAGS=""
export CXXFLAGS=""
